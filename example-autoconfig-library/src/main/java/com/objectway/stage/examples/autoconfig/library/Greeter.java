package com.objectway.stage.examples.autoconfig.library;
...
public class Greeter {
    ...
    public String greet(LocalDateTime localDateTime) {
        final String name = greetingConfig.getProperty(USER_NAME);
        final int hourOfDay = localDateTime.getHour();
